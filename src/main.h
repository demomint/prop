...
static const int64 MAX_MONEY = 500000000 * COIN; // PropCoin: maximum of 500m coins (given some randomness), max transaction 500,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 100 * COIN * 144 / 250; // PropCoin: 1440 blocks found a day. Priority cutoff is 100 propcoin day / 250 bytes.
    }
