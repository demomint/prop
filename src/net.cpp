...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "PropCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"propcoin.ru", "seed.propcoin.ru"},
//    {"propcoinpool.org", "dnsseed.propcoinpool.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. PropCoin is probably already running."), addrBind.ToString().c_str());
        else
